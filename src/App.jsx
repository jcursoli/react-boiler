  ...
  render() {
    return (
      <div className={styles.main}>
        ...
        <Carousel inView={5} seperation={30} animationTime={500} skipBy={1} infinite>
...
export default App;
{/* <div style={{background: "gold", height: '300px'}} key={1}>1</div>
<div style={{background: "gold", height: '300px'}} key={2}>2</div>
<div style={{background: "gold", height: '300px'}} key={3}>3</div>
<div style={{background: "gold", height: '300px'}} key={4}>4</div>
<div style={{background: "gold", height: '300px'}} key={5}>5</div>
<div style={{background: "gold", height: '300px'}} key={6}>6</div>
<div style={{background: "gold", height: '300px'}} key={7}>7</div>
<div style={{background: "gold", height: '300px'}} key={8}>8</div>
<div style={{background: "gold", height: '300px'}} key={9}>9</div>
<div style={{background: "gold", height: '300px'}} key={10}>10</div> */}
